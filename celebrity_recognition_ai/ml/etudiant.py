...
class StudentEfficientNetB4(nn.Module):
    def __init__(self, num_classes=6, dropout_rate=0.5):
        ...
        self.blocks = nn.Sequential(
            ...
            SimplifiedMBConvBlock(320, 512, expand_ratio=6, stride=1, dropout_rate=dropout_rate),
            SimplifiedMBConvBlock(512, 1020, expand_ratio=6, stride=1, dropout_rate=dropout_rate)
