...
import data, test_accuracy, logging_config, models,mobilenet_v2_100,student_bo
...
if __name__ == "__main__":
    ...
    (train_images_absolute_paths, validation_images_absolute_paths) = (
        data.get_train_and_validation_images_path(
            datapath, categories, percentage_train=0
        )
    )
    ...
    # model_path = '/home/holy/Documents/memoire/celebrity-recognition-ai/celebrity_recognition_ai/app/trained-models/studentb0_original.pth'
    # net.load_state_dict(torch.load(model_path))

    # torch.manual_seed(123)
    # net = mobilenet_v2_100.Mobilenet_100()
    # model_path ='/home/holy/Documents/memoire/celebrity-recognition-ai/student_b0.pth'
    # net.load_state_dict(torch.load(model_path))
